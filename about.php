...
<body>
    ...
    <div class="container overflow-x-hidden">
        ...
        <div class="row bottom-margin gy-5 gy-lg-0">
            <div class="col-lg-6 text-center d-flex flex-column justify-content-center align-items-center border-end-lg" data-aos="fade-right">
                <div class="max-width">
            ...
            <div class="col-lg-6 px-4 d-flex justify-content-center" data-aos="fade-left">
        ...
        <div class="custom-container container section-padding">
            ...
            <div class="row gy-5 gy-lg-0">
                ...
                <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center text-center border-end-lg" data-aos="fade-up" data-aos-delay="100">
                    <img src="img/about/about-image-5.jpg" alt="" class="img-fluid">
    ...
    <div class="container overflow-x-hidden">
        <div class="row bottom-margin gy-5 gy-lg-0">
            <div class="col-lg-6 px-4 border-end-lg d-flex justify-content-center" data-aos="fade-right">
                <img src="img/about/about-image-3.jpg" alt="" class="img-fluid">
            </div>

<?php
$title = "About BC Orchard | From Ingredient Integrity to Wellness-First Living";
$description = "BC Orchard is a Canadian company bringing you 100% pure coconut water and nutritious products with global ingredients and a local heart. Discover our story and values.";
    ...
    <div class="container section-padding-sm">
        <div class="row">
            <div class="about-banner-text col-lg-4 text-white d-flex flex-column justify-content-center order-2 order-lg-1">
                ...
                <p class="text-justify">At BC Orchard, everything we create reflects our belief in better living. From sourcing to packaging, every choice is guided by one promise: to support your well-being with honesty, intention, and care. What you taste is only part of the story—the rest is what we stand for.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="custom-container container section-padding">
        ...
        <div class="row gy-5 gy-lg-0">
            <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center text-center border-end-md" data-aos="fade-up" data-aos-delay="0">
                <img src="img/about/bc-orchard-core-value-quality-blueberries-harvest.jpg" loading="lazy" alt="Quality Blueberry held in hands" class="img-fluid">
                <div class="upper-header mt-5">Quality</div>
            ...
            <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center text-center border-end-lg" data-aos="fade-up" data-aos-delay="100">
                <img src="img/about/bc-orchard-core-value-health-yoga-mother-child.jpg" loading="lazy" alt="Mother and child practicing yoga at home" class="img-fluid">
                <div class="upper-header mt-5">Health</div>
            ...
            <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center text-center border-end-md" data-aos="fade-up" data-aos-delay="200">
                <img src="img/about/bc-orchard-core-value-flavour-child-eating-cookie.jpg" loading="lazy" alt="Smiling child eating a cookie—flavour that brings joy." class="img-fluid">
                <div class="upper-header mt-5">Flavour</div>
                <h5>Taste the Joy</h5>
            ...
            <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center text-center" data-aos="fade-up" data-aos-delay="300">
                <img src="img/about/bc-orchard-core-value-transparency-reading-juice-label.jpg" loading="lazy" alt="Woman reading juice label in store—transparency you can trust." class="img-fluid">
                <div class="upper-header mt-5">Transparency</div>
...
<div class="container overflow-x-hidden">
    <div class="row bottom-margin gy-5 gy-lg-0">
        <div class="col-lg-6 px-4 border-end-lg d-flex justify-content-center" data-aos="fade-right">
            <img src="img/about/bc-orchard-why-it-matters.jpg" loading="lazy" alt="Couple on wooden mountain bench raising hands to the sky—active, healthy lifestyle" class="img-fluid">
        </div>

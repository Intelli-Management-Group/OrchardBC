...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Gilda+Display&family=Lato:wght@400;700&display=swap" rel="stylesheet">
            ...
            <div class="custom-container container d-flex justify-content-between align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav d-flex justify-content-start w-100 column-gap-3">
                        ...
                        <li class="nav-item"><a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'coconut-water.php' ? 'active' : ''; ?>" href="coconut-water.php">Coconut Water</a></li>

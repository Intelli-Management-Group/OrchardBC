    ...
    <div class="container section-padding-sm pt-0-sm">
        <div class="row">
            ...
            <div class="col-lg-4 text-white d-flex flex-column justify-content-center order-2 order-lg-1">
                ...
                <p class="text-justify pb-4">From coconut straight to bottle, our coconut water is naturally sweet, packed with essential electrolytes, and free from additives, making it the cleanest way to refresh your day. No matter the occasion—workouts or wind-downs—this is true hydration.</p>
            </div>
        </div>
    </div>
    ...
    <div class="section-padding-sm pb-0 bottom-margin">
        ...
        <div class="row mt-5 gy-md-0">
            <div class="col-md-4 d-flex flex-column align-items-center text-center" data-aos="fade-up" data-aos-delay="0">
                <img src="img/coconut/bc-orchard-electrolyte-rich-hydration-icon.png" loading="lazy" alt="Electrolyte-rich hydration icon—a water droplet with hexagon cells." class="benefits-img">
            ...
            <div class="col-md-4 d-flex flex-column align-items-center text-center" data-aos="fade-up" data-aos-delay="100">
                <img src="img/coconut/bc-orchard-immunity-support-icon.png" loading="lazy" alt="Immunity support icon—atom-style lines for vitamin C benefits." class="benefits-img">
            ...
            <div class="col-md-4 d-flex flex-column align-items-center text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="img/coconut/bc-orchard-skin-and-recovery-antioxidants-icon.png" loading="lazy" alt="Skin and recovery icon—a molecular network indicating antioxidants." class="benefits-img">
...
<section class="product-coconut-bg-2">
    <svg viewBox="0 0 100 100" preserveAspectRatio="none" class="convex-cover">
        <path d="M0,100 Q50,0 100,100 L100,0 L0,0 Z" fill="white" />
    </svg>

    <img src="img/coconut/bc-orchard-young-coconut-half-corner-left.png" loading="lazy" alt="BC Orchard young coconut" class="floating-coconut-1">
    <img src="img/coconut/bc-orchard-young-coconut-half-corner-right.png" loading="lazy" alt="BC Orchard young coconut" class="floating-coconut-2">
    <div class="container-xxl section-padding">
        <h2 class="text-center mb-5 text-darkblue">Crafted from Young Coconuts</h2>
        <div class="bg-white rounded-5 p-3 shadow">
            <div class="row">
                <div class="col-lg-7">
                    <img src="img/coconut/bc-orchard-young-coconut-on-tree.jpg" loading="lazy" alt="Young coconut on tree" class="product-highlight-img-bg">
                </div>

                <div class="col-lg-5">
                    <div class="row mb-30" data-aos="fade-up" data-aos-delay="0">
                        <div class="col-4">
                            <img src="img/coconut/bc-orchard-coconut-water-naturally-sweet.jpg" loading="lazy" alt="Kid drinking BC Orchard coconut water—naturally sweet from young coconuts." class="product-highlight-img-sm">
                        </div>
                    ...
                    <div class="row mb-30" data-aos="fade-up" data-aos-delay="100">
                        <div class="col-4">
                            <img src="img/coconut/bc-orchard-coconut-water-rich-in-nutrients.jpg" loading="lazy" alt="Glass of coconut water with C, K, Ca, Mg icons—rich in nutrients and electrolytes" class="product-highlight-img-sm" style="object-position: 30% center;">
                        </div>
                        <div class="col-8 d-flex flex-column justify-content-center">
                    ...
                    <div class="row" data-aos="fade-up" data-aos-delay="200">
                        <div class="col-4">
                            <img src="img/coconut/bc-orchard-coconut-water-pure-glass-with-coconut-wedges.jpg" loading="lazy" alt="Glass of coconut water with young coconut wedges—100% pure and natural." class="product-highlight-img-sm" style="object-position: 80% center;">
                        </div>
                        <div class="col-8 d-flex flex-column justify-content-center">
                            <h6>100% Pure</h6>
        ...
        <div class="row top-margin">
            ...
            <div class="col-lg-4 d-flex justify-content-center order-lg-1 order-0 mt-0" data-aos="fade-up">
                <img src="img/coconut/bc-orchard-coconut-water-can.png" loading="lazy" alt="Young coconut pouring fresh coconut water into a glass—100% pure" class="img-fluid product-nutrition-img">
            </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body d-flex justify-content-center">
                                    <img src="img/coconut/bc-orchard-coconut-water-nutrition-facts.jpg" class="img-fluid" loading="lazy" alt="BC Orchard Coconut Water Nutrition Label" style="max-height: 750px;">
                                </div>
                            </div>
                        </div>
                    </div>
